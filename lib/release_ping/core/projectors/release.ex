defmodule ReleasePing.Core.Projectors.Release do
  ...
  project %ReleaseNotesUrlAdjusted{} = adjusted, _metadata do
    update_release(multi, adjusted.software_uuid, adjusted.version_string, :release_notes_url, adjusted.release_notes_url)
  end

  defp update_release(multi, software_uuid, version_string, field_name, value) do
    existing_release = ReleasePing.Repo.get_by(Release, software_uuid: software_uuid, version_string: version_string)
    changeset = existing_release
